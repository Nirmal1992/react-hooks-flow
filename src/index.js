...
function Child() {
  ...
  React.useLayoutEffect(() => {
    console.log("%c    Child: useLayoutEffect no deps", "color: Wheat");
    return () => {
      console.log(
        "%c    Child: useLayoutEffect no deps cleanup",
        "color: Wheat"
      );
    };
  });
...
function App() {
  ...
  React.useLayoutEffect(() => {
    console.log("%cApp: useLayoutEffect no deps", "color: Wheat");
    return () => {
      console.log("%cApp: useLayoutEffect no deps cleanup", "color: Wheat");
    };
  });
